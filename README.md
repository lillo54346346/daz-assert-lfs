[![Git Anti Virus Scan](https://github.com/lillo54346346/daz-assert-lfs/actions/workflows/antivirus.yml/badge.svg)](https://github.com/lillo54346346/daz-assert-lfs/actions/workflows/antivirus.yml)

## How to work
Before you start creating a scene check the [wiki](https://github.com/lillo54346346/daz-assert-lfs/wiki) to see if there is an element best suited for you.
